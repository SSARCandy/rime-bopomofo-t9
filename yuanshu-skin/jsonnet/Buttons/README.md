...
各文件及包含的按键对应如下：
- README.md：本说明文件。
- Common：一些通用按键功能，例如 shift, space, enter 等。
- LayoutT9Zhuyin：T9 注音九宮格鍵盤（本皮膚的主鍵盤）。
- LayoutNumericT9：T9 數字九宮格鍵盤。
- Layout26：26 鍵英文鍵盤（僅作為密碼/Email 等強制英文欄位的後備，
  日常英文輸入建議用 iOS 系統英文鍵盤）。
- Toolbar：工具栏和浮动面板中的按键。

（上游 kongshan-suying 的其他佈局檔已於此精簡版移除。）
